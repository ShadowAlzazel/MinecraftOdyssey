...
object OldCauldronRecipes {

    // Potion Results
    private val CRYSTALLINE_POTION_RECIPE = OldCauldronRecipe(
    ...
    private val POTION_OF_LEVITATION_RECIPE = OldCauldronRecipe(
    ...
    private val POTION_OF_WITHERING_RECIPE = OldCauldronRecipe(
    ...
    private val POTION_OF_BIOLUMINESCENCE = OldCauldronRecipe(
    ...
    private val POTION_OF_LUCK_RECIPE = OldCauldronRecipe(
    ...
    private val POTION_OF_RESISTANCE_RECIPE = OldCauldronRecipe(
    ...
    private val POTION_OF_HASTE_RECIPE = OldCauldronRecipe(
    ...
    private val POTION_OF_CONSTITUTION_RECIPE = OldCauldronRecipe(
    ...
    private val POTION_OF_STONE_SKIN_RECIPE = OldCauldronRecipe(
    ...
    private val POTION_OF_WRATH_RECIPE = OldCauldronRecipe(
    ...
    private val POTION_OF_WHIZ_RECIPE = OldCauldronRecipe(
    ...
    private val FLASK_OF_DECAY_RECIPE = OldCauldronRecipe( // TODO: Change
        brewedPotion = Potions.FLASK_OF_ROT,
        ingredientList = listOf(
    ...
    private val FLASK_OF_FROST_RECIPE = OldCauldronRecipe(
    ...
    private val FLASK_OF_DOUSE_RECIPE = OldCauldronRecipe( // TODO: Change
        brewedPotion = Potions.FLASK_OF_TAR,
        ingredientList = listOf(
    ...
    private val POTION_OF_ABLAZE_RECIPE = OldCauldronRecipe(
    ...
    private val FLASK_OF_IRRADIATION_RECIPE = OldCauldronRecipe( // TODO: Change
        brewedPotion = Potions.FLASK_OF_IRRADIATION,
        ingredientList = listOf(
    ...
    private val FLASK_OF_MIASMA_RECIPE = OldCauldronRecipe( // TODO: Change
    ...
    private val BOTTLED_SOULS_RECIPE = OldCauldronRecipe(
    ...
    private val POTION_OF_SHIMMER_RECIPE = OldCauldronRecipe(
    ...
    private val ACCURSED_BREW_RECIPE = OldCauldronRecipe(
        brewedPotion = Potions.ACCURSED_BREW,
        ingredientList = listOf(
    ...
    val CAULDRON_SET = setOf(CRYSTALLINE_POTION_RECIPE, POTION_OF_LEVITATION_RECIPE, POTION_OF_WITHERING_RECIPE, POTION_OF_BIOLUMINESCENCE, POTION_OF_LUCK_RECIPE,
        ...
        FLASK_OF_DOUSE_RECIPE, POTION_OF_ABLAZE_RECIPE, FLASK_OF_FROST_RECIPE, FLASK_OF_IRRADIATION_RECIPE, FLASK_OF_MIASMA_RECIPE, BOTTLED_SOULS_RECIPE, ACCURSED_BREW_RECIPE,
