...
object PotionOfDecay : OdysseyPotion("Bottle o' Decay",
    ...
    listOf(Component.text("Decaying (0:20)", TextColor.color(114, 227, 154)).decoration(TextDecoration.ITALIC, TextDecoration.State.FALSE)),
...
object PotionOfFrost : OdysseyPotion("Bottle o' Frost",
    ...
    listOf(Component.text("Freezing (0:20)", TextColor.color(163, 211, 255)).decoration(TextDecoration.ITALIC, TextDecoration.State.FALSE)),
    potionEffects = emptyList(),
...
object PotionOfAblaze : OdysseyPotion("Bottle o' Ablaze",
    ...
    listOf(Component.text("Blazing (0:20)", TextColor.color(247, 74, 0)).decoration(TextDecoration.ITALIC, TextDecoration.State.FALSE)),
    potionEffects = emptyList(),
