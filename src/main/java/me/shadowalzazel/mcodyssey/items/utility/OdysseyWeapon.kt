...
open class OdysseyWeapon(weaponName: String, weaponMaterial: Material, weaponCustomModel: Int, private val attackDamage: Double, private val attackSpeed: Double) :
