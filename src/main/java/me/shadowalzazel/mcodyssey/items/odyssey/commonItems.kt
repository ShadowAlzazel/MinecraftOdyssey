...
object HawkingEntangledUnit : OdysseyItem("Hawking Entangled Unit", Material.ENDER_CHEST,
    ...
    listOf("A linked vacuum of matter and energy..."),
    customModel = CustomModels.HAWKING_ENTANGLED_UNIT)

// Kugelblitz Containment Silo
object KugelblitzContainmentUnit : OdysseyItem("Kugelblitz Containment Unit", Material.PURPLE_SHULKER_BOX,
    ...
    listOf("A portable device capable of holding large amounts of matter"),
    customModel = CustomModels.KUGELBLITZ_CONTAINMENT_UNIT)
