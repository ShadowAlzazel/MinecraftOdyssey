...
open class Scythe (battleaxeName: String, battleaxeMaterial: Material, battleaxeCustomModel: Int, private val attackDamage: Double, private val attackSpeed: Double) :
