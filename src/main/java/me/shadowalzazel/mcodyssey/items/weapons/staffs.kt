...
object WoodenStaff: Staff("Wooden Staff", Material.WOODEN_SHOVEL, ItemModels.WOODEN_STAFF, 3.5, 1.25)

object BlazeRodStaff: Staff("Blaze Rod Staff", Material.IRON_SHOVEL, ItemModels.BLAZE_ROD_STAFF, 4.0, 1.1)