...
object SolarPhenomena {
    ...
    val GRAVITY_SHIFT: SolarPhenomenon = GravityShift
    val SHIMMER_INTOXICATION: SolarPhenomenon = ShimmerIntoxication
    val SLIME_STORM: SolarPhenomenon = SlimeShower
    val SOLAR_FLARE: SolarPhenomenon = SolarFlare
