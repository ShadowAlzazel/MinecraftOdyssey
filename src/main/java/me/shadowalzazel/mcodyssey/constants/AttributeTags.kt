...
object AttributeTags {
    ...
    const val PLAYER_MOVEMENT_SPEED = "odyssey.movement_speed"
    ...
    const val ITEM_RUNE_ATTACK_DAMAGE = "odyssey.item_rune_attack_damage"
    const val ITEM_RUNE_ATTACK_REACH = "odyssey.item_rune_entity_interaction_range"
    const val ITEM_RUNE_BLOCK_REACH = "odyssey.item_rune_block_interaction_range"
