...
class Food {
    ...
    private fun createBeetrootCookieRecipe(): ShapedRecipe {
        val someResult = Foods.BEETROOT_COOKIE.newItemStack(1)
    ...
    private fun createPumpkinCookieRecipe(): ShapedRecipe {
        val someCookie = Foods.PUMPKIN_COOKIE.newItemStack(1)
    ...
    private fun createHoneyCookieRecipe(): ShapedRecipe {
        val someCookie = Foods.HONEY_COOKIE.newItemStack(1)
    ...
    private fun createAppleCookieRecipe(): ShapedRecipe {
        val someCookie = Foods.APPLE_COOKIE.newItemStack(1)
    ...
    private fun createBerryCookieRecipe(): ShapedRecipe {
        val someCookie = Foods.BERRY_COOKIE.newItemStack(1)
    ...
    private fun createGlowBerryCookieRecipe(): ShapedRecipe {
        val someCookie = Foods.GLOW_BERRY_COOKIE.newItemStack(1)
    ...
    private fun createMelonCookieRecipe(): ShapedRecipe {
        val someCookie = Foods.MELON_COOKIE.newItemStack(1)
    ...
    private fun createSugarCookieRecipe(): ShapedRecipe {
        val someCookie = Foods.SUGAR_COOKIE.newItemStack(1)
    ...
    private fun createGoldenCookieRecipe(): ShapedRecipe {
        val someCookie = Foods.GOLDEN_COOKIE.newItemStack(1)
    ...
    private fun createSugaryBreadRecipe(): ShapedRecipe {
        val someResult = Foods.SUGARY_BREAD.newItemStack(1)
    ...
    private fun chocolateMochi(): ShapedRecipe {
        val result = Foods.CHOCOLATE_MOCHI.newItemStack(1)
    ...
    private fun fishNChipsRecipe(): ShapedRecipe {
        val result = Foods.FISH_N_CHIPS.newItemStack(1)
    ...
    private fun fruitBowlRecipe(): ShapelessRecipe {
        val result = Foods.FRUIT_BOWL.newItemStack(1)
    ...
    private fun spiderEyeBobaRecipe(): ShapedRecipe {
        val result = Foods.SPIDER_EYE_BOBA.newItemStack(1)
    ...
    private fun coffeeRecipe(): ShapedRecipe {
        val result = Foods.COFFEE.newItemStack(1)
    ...
    private fun salmonRollRecipe(): ShapedRecipe {
        val result = Foods.SALMON_ROLL.newItemStack(2)
    ...
    private fun createBaconRecipe(): CampfireRecipe {
        val someResult = Foods.BACON.newItemStack(1)
    ...
    private fun createFrenchToastRecipe(): SmokingRecipe {
        val someResult = Foods.FRENCH_TOAST.newItemStack(1)
        val someExactIngredient = Foods.SUGARY_BREAD.newItemStack(1)
