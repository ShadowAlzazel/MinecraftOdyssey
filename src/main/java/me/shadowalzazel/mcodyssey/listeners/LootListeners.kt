        ...
        when (mob) {
            is Skeleton -> {
                if (mobLootLogic.roll(2.5)) {
                    ...
                    mob.world.dropItem(mob.location, (Miscellaneous.GILDED_BOOK.createGildedBook(rangedSet.random(), 1)))
                    droppedItemSound(player)
                }
            }
            is Husk -> {
                if (mobLootLogic.roll(1.5)) {
                    mob.world.dropItem(mob.location, (Miscellaneous.GILDED_BOOK.createGildedBook(OdysseyEnchantments.DECAYING_TOUCH, 1)))
                    droppedItemSound(player)
                }
            }
            is Drowned -> {
                if (mobLootLogic.roll(1.5)) {
                    mob.world.dropItem(mob.location, (Miscellaneous.GILDED_BOOK.createGildedBook(OdysseyEnchantments.BANE_OF_THE_SEA, 1)))
                    droppedItemSound(player)
                }
            }
            is PigZombie -> {
                if (mobLootLogic.roll(1.5)) {
                    mob.world.dropItem(mob.location, (Miscellaneous.GILDED_BOOK.createGildedBook(OdysseyEnchantments.BANE_OF_THE_SWINE, 1)))
                    droppedItemSound(player)
                }
            }
            is Zombie -> {
                if (mobLootLogic.roll(2.5)) {
                    ...
                    mob.world.dropItem(mob.location, (Miscellaneous.GILDED_BOOK.createGildedBook(meleeSet.random(), 1)))
                    droppedItemSound(player)
                }
                // TODO: Is Blood Moon
            ...
            is Witch -> {
                if (mobLootLogic.roll(2.5)) {
                    mob.world.dropItem(mob.location, (Miscellaneous.GILDED_BOOK.createGildedBook(OdysseyEnchantments.ALCHEMY_ARTILLERY, 1)))
                    droppedItemSound(player)
                }
            }
            is Stray -> {
                if (mobLootLogic.roll(1.5)) {
                    mob.world.dropItem(mob.location, (Miscellaneous.GILDED_BOOK.createGildedBook(OdysseyEnchantments.FREEZING_ASPECT, 1)))
                    droppedItemSound(player)
                }
            }
            is Creeper -> {
                ...
                if (mobLootLogic.roll(1.5)) {
                    mob.world.dropItem(mob.location, (Miscellaneous.GILDED_BOOK.createGildedBook(OdysseyEnchantments.EXPLODING, 1)))
                    droppedItemSound(player)
                }
            }
            is Hoglin -> {
                if (mobLootLogic.roll(1.5)) {
                    mob.world.dropItem(mob.location, (Miscellaneous.GILDED_BOOK.createGildedBook(OdysseyEnchantments.HEMORRHAGE, 1)))
                    droppedItemSound(player)
                }
            }
            is Vindicator -> {
                if (mobLootLogic.roll(3.5)) {
                    mob.world.dropItem(mob.location, (Miscellaneous.GILDED_BOOK.createGildedBook(OdysseyEnchantments.BANE_OF_THE_ILLAGER, 1)))
                    droppedItemSound(player)
                }
            }
            is Pillager -> {
                if (mobLootLogic.roll(2.5)) {
                    mob.world.dropItem(mob.location, (Miscellaneous.GILDED_BOOK.createGildedBook(OdysseyEnchantments.BURST_BARRAGE, 1)))
                    droppedItemSound(player)
                }
            }
            is Ravager -> {
                if (mobLootLogic.roll(5.5)) {
                    mob.world.dropItem(mob.location, (Miscellaneous.GILDED_BOOK.createGildedBook(OdysseyEnchantments.WHIRLWIND, 1)))
                    droppedItemSound(player)
                }
            }
            is Squid -> {
                if (mobLootLogic.roll(3.5)) {
                    mob.world.dropItem(mob.location, (Miscellaneous.GILDED_BOOK.createGildedBook(OdysseyEnchantments.SQUIDIFY, 1)))
                    droppedItemSound(player)
                }
            }
            is Shulker -> {
                if (mobLootLogic.roll(2.5)) {
                    mob.world.dropItem(mob.location, (Miscellaneous.GILDED_BOOK.createGildedBook(OdysseyEnchantments.VOID_STRIKE, 1))) // change
                    droppedItemSound(player)
                }
            }
            is Endermite -> {
                if (mobLootLogic.roll(3.5)) {
                    mob.world.dropItem(mob.location, (Miscellaneous.GILDED_BOOK.createGildedBook(OdysseyEnchantments.VOID_STRIKE, 1)))
                    droppedItemSound(player)
                }
            }
            is Enderman -> {
                if (mobLootLogic.roll(2.5)) {
                    mob.world.dropItem(mob.location, (Miscellaneous.GILDED_BOOK.createGildedBook(OdysseyEnchantments.VOID_JUMP, 1)))
                    droppedItemSound(player)
                }
            }
            is Vex -> {
            ...
            is Warden -> {
                ...
                mob.world.dropItem(mob.location, (Miscellaneous.GILDED_BOOK.createGildedBook(OdysseyEnchantments.SCULK_SENSITIVE, 1)))
                droppedItemSound(player)
            }
            is Wither -> {
                mob.world.dropItem(mob.location, (Miscellaneous.GILDED_BOOK.createGildedBook(OdysseyEnchantments.BLACK_ROSE, 1)))
                droppedItemSound(player)
            }
            is EnderDragon -> {
            }
